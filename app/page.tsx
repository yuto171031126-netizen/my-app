    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-50 font-sans selection:bg-purple-500 selection:text-white relative overflow-hidden">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 relative z-10">
        <header className="text-center mb-16">
          ...
          <div className="inline-block px-6 py-2 bg-zinc-900/50 backdrop-blur-md border border-zinc-800 rounded-full text-zinc-300">
            2027.03.20 | 中部講堂
          </div>
        </header>
...
function MenuCard({ href, title, desc }: { href: string, title: string, desc: string }) {
  return (
    <a href={href} className="p-6 bg-zinc-900/40 backdrop-blur-sm border border-zinc-800 rounded-2xl hover:border-purple-500/50 hover:bg-zinc-800/60 transition-all duration-300 shadow-lg">
